...
var sensorSketch = function (p){
    ...
    p.canvaWidth = 600/2/someScaleCamera;
    p.canvasHeight = 480/2/someScaleCamera;
    ...
    */
    ...
    try {
        ...
        myCapture.size(320/someScaleCamera, 240/someScaleCamera);
    ...
    */
    myVida.setActiveZonesNormFillThreshold(0);
    /*
        ...
        resolution.
    */
    var padding = 0.25; var n = 1; //how many active zones
    var zoneWidth = 0.5; var zoneHeight = 0.1;
    var hOffset = (1.2 - (n * zoneWidth + (n - 1) * padding)) / 3.0;
    var vOffset = 0.1;
    for(var i = 0; i < n; i++) {
        /*
    ...
    p.frameRate(60); // set framerate
    // p.frameRate(2); //setting framerate slower slows down the sensor update speed
